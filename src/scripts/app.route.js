...
function($routeProvider) {
	...
	$routeProvider
		// application
		.when('/app', 				{templateUrl:_view_+_app_+'index.html', 	controller:'app.controller.dashboard'})

		// sign up/in/reset
		.when('/sign/:action', 		{templateUrl:_view_+'account/sign.html',	controller:'io.controller.sign'})
		...
		.when('/user/profile', 		{templateUrl:_view_+'user/profile.html',	controller:'io.controller.user'})
		.when('/user/profile/:profile_ID', {templateUrl:_view_+'user/profile.html',	controller:'io.controller.user'})
		...
		.when('/:page', 				{templateUrl:_view_+'page.html', 			controller:'io.controller.page'})
